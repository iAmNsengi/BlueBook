export const createWelcomeEmailTemplate = (name, profileUrl) => {
  ...
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(to right, #0077B5, #00A0DC); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
      <img src="https://res.cloudinary.com/dfgr4talb/image/upload/v1739375928/Screenshot_2025-02-12_170930_fhqoww.png" alt="Vuga Logo" style="width: 150px; margin-bottom: 20px;border-radius: 10px;">
...
export const createResetPasswordEmailTemplate = (name, resetUrl) => {
  return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
